...
class GuildNews_Widget extends WP_Widget 
{
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'guild' ); ?>"><?php _e('Guild Name:', 'guildnews'); ?></label>
			<input id="<?php echo $this->get_field_id( 'guild' ); ?>" name="<?php echo $this->get_field_name( 'guild' ); ?>" value="<?php echo $instance['guild']; ?>" style="width:100%;" />
		</p>
		
		<!-- Realm Name: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'realm' ); ?>"><?php _e('Realm Name:', 'guildnews'); ?></label>
			<input id="<?php echo $this->get_field_id( 'realm' ); ?>" name="<?php echo $this->get_field_name( 'realm' ); ?>" value="<?php echo $instance['realm']; ?>" style="width:100%;" />
		</p>

		<!-- Region: Select Box -->
		<p>
			<label for="<?php echo $this->get_field_id( 'region' ); ?>"><?php _e('Region:', 'guildnews'); ?></label> 
			<select id="<?php echo $this->get_field_id( 'region' ); ?>" name="<?php echo $this->get_field_name( 'region' ); ?>" class="widefat" style="width:100%;">
				<option <?php if ( 'eu.battle.net' == $instance['region'] ) echo 'selected="selected"'; ?>>eu.battle.net</option>
				<option <?php if ( 'us.battle.net' == $instance['region'] ) echo 'selected="selected"'; ?>>us.battle.net</option>
			</select>
		</p>
		
		<!-- Number of News Items: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'max' ); ?>"><?php _e('Number of News Items: (empty for all)', 'guildnews'); ?></label>
